...
<nav class="navbar navbar-default navbar-fixed-top">
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row xx-div-search">
				<!--<div class="col-md-6">
					<form action="/HosMa9/admin.php/Doctor/index" method="get" class="form-horizontal">
	...
	<script>
		var SCOPE = {
			'add_url':'/HosMa9/admin.php/Doctor/add',
			'save_url':'/HosMa9/admin.php/Doctor/save',
			'success_jump_url':'/HosMa9/admin.php/Doctor/index',
			'set_status_url':'/HosMa9/admin.php/Doctor/setStatus',
			'ajax_upload_swf':'/HosMa9/Public/js/vendor/uploadify/uploadify.swf',
			'ajax_upload_url':'/HosMa9/admin.php/Doctor/ajaxUploadImage',
		};
