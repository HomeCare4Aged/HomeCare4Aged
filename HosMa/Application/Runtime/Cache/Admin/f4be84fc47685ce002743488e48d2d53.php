...
<nav class="navbar navbar-default navbar-fixed-top">
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row xx-div-search">
				<!--<div class="col-md-6">
					<form action="/hosma01/admin.php/Doctor/index" method="get" class="form-horizontal">
	...
	<script>
		var SCOPE = {
			'add_url':'/hosma01/admin.php/Doctor/add',
			'save_url':'/hosma01/admin.php/Doctor/save',
			'success_jump_url':'/hosma01/admin.php/Doctor/index',
			'set_status_url':'/hosma01/admin.php/Doctor/setStatus',
			'ajax_upload_swf':'/hosma01/Public/js/vendor/uploadify/uploadify.swf',
			'ajax_upload_url':'/hosma01/admin.php/Doctor/ajaxUploadImage',
		};
