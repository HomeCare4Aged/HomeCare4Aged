		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<label for="xx-input-announcement_end_date" class="control-label col-sm-3">公告撤销时间:</label>
					<div class="col-sm-5">
                     ...
                     <div class="input-prepend input-group">
                       <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span><input type="text" disabled="" style="width: 200px" name="announcement_end_date" id="xx-input-announcement_end_date" class="form-control" value="<?php echo ($announcement["announcement_end_date"]); ?>" /> 
                     </div>
                    </div>
					</div>
					<div class="col-sm-4">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<p id="xx-input-announcement_check_state" class="form-control" name="announcement_check_state" disabled=""/><?php echo ($announcement["announcement_check_state"]); ?></p>	
					</div>
				</div>
				<div class="form-group">
					<label for="xx-input-announcement_check_id" class="control-label col-sm-3">审核人:</label>
					<div class="col-sm-5">
						<p id="xx-input-announcement_check_id" class="form-control" name="announcement_check_id" disabled=""/><?php echo ($announcement["hospital_user_name"]); ?></p>	
					</div>
				</div>
				<div class="form-group">
					<label for="xx-input-error_message" class="control-label col-sm-3">反馈信息:</label>
					<div class="col-sm-5">
						<p id="xx-input-error_message" class="form-control" name="error_message" disabled=""/><?php echo ($announcement["error_message"]); ?></p>
					</div>
				</div>
						<div class="row">
							<div class="col-sm-7 col-lg-offset-5">
								<button type="button"  id="xx-btn-addd" class="btn btn-primary" <?php if($result == 0): ?>disabled<?php endif; ?>>编辑</button>						
							</div>							
						</div>
...
<script>
	...
	$('#xx-btn-addd').click(function(){
		var formData = $('#xx-form-add').serializeArray();
		var postData = {};
		$(formData).each(function(i){
			postData[this.name] = this.value;
		});
		var id = postData['announcement_id'];
		var num = postData['announcement_version_number'];
		location.href = '/hosma/admin.php/Noticle/edit'+'?id='+id+'&num='+num;	
	});
