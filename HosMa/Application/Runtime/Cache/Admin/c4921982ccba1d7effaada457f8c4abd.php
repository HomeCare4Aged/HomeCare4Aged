			...
			<div class="row">
				<div class="col-md-12">
					<ol class="breadcrumb">
						...
						<a href="/HosMa7/admin.php/Account/index" class="active">个人中心</a>
					</ol>
				</div>
			</div>
...
<script>
	var SCOPE = {
		'add_url':'/HosMa7/admin.php/Account/index',
		'edit_url':'/HosMa7/admin.php/Account/edit',
		'set_status_url':'/HosMa7/admin.php/Account/setStatus',
		'list_order_url':'/HosMa7/admin.php/Account/listOrder',
		'success_jump_url':'/HosMa7/admin.php/Login/loginout',
	};
</script>	
