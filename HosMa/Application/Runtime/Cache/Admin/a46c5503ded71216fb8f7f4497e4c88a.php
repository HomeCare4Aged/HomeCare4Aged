		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">   <!--面包屑导航-->
						<li class="">
							<i class="fa fa-fw fa-edit"></i>编辑视频
						</li>
					</ol>
				</div>
			</div>
			<div class="row">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input id="xx-input-community_hospitals_id" class="form-control" type="text" name="community_hospitals_id" placeholder="请输入发布单位" value="<?php echo ($video["community_hospitals_id"]); ?>"/>
					</div>
					<div class="col-sm-4">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input id="xx-input-video_title" class="form-control" type="text" name="video_title" placeholder="请输入视频标题" value="<?php echo ($video["video_title"]); ?>"/>
					</div>
					<div class="col-sm-4">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input id="xx-input-video_introduction" class="form-control" type="text" name="video_introduction" placeholder="请输入视频简介" value="<?php echo ($video["video_introduction"]); ?>"/>
					</div>
					<div class="col-sm-4">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="radio" name="video_type_name" value="1" <?php if($video['video_type_name'] == 1): ?>checked<?php endif; ?>/>内科
						<input type="radio" name="video_type_name" value="0" <?php if($video['video_type_name'] == 0): ?>checked<?php endif; ?>/>外科
						
					</div>
				</div>
				<div class="form-group">
					<label for="video_type_id"class="control-label col-sm-3">状态:</label>
					<div class="col-sm-5">
						<input type="radio" name="status" value="1" <?php if($video['status'] == 1): ?>checked<?php endif; ?>/>开启
						<input type="radio" name="status" value="0" <?php if($video['status'] == 0): ?>checked<?php endif; ?>/>关闭
					</div>
				</div>
				<div class="row">
