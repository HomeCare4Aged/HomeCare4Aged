	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row xx-div-search">
				<div class="col-md-6">
					<form action="/HosMa7/admin.php/Department/index" method="get" class="form-horizontal" id="xx-form-add-keshi">
...
<script>
	var SCOPE = {
		'add_url': '/HosMa7/admin.php/Department/add',
		'save_url':'/HosMa7/admin.php/Department/save',
		'success_jump_url':'/HosMa7/admin.php/Department/index',
	};
