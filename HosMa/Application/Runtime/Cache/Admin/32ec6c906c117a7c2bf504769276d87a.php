...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/hosma01/Public/css/admin/login.css" />
	</head>
	...
	<body>
					...
					<form id="xx-form-login" name="form">
						...
						<!--<div class="form-group">-->
							...
							<!--<div class="col-sm-5" id="xx-div-val-img">-->
								<!--<img src="/hosma01/admin.php/Login/veriyfyImg" />-->
		...
		<script type="text/javascript" src="/hosma01/Public/js/admin/login.js"></script>
		<script type="text/javascript" src="/hosma01/Public/js/loginDialog.js"></script>
		<script type="text/javascript" src="/hosma01/Public/js/admin/login.js" ></script>
		<!--写地址用于json路径跳转-->
		<script>
			var SCOPE = {
				'login_url': '/hosma01/admin.php/Login/check',
				'success_jump_url': '/hosma01/admin.php/Index/index',
				'verify_url': '/hosma01/admin.php/Login/veriyfyImg',
			};
		</script>
	</body>
