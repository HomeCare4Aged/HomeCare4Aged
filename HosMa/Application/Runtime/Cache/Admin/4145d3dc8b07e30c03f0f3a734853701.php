	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-sm-12">
					<!--<div class="col-lg-6">-->
						<form class="form-horizontal" action="/HosMa9/admin.php/Noticle/review" method="post" id="xx-form-span">
...
<script>
	var SCOPE={
		...
		'success_refresh_url':'/HosMa9/admin.php/Noticle/review',
		'manage_url':'/HosMa9/admin.php/Noticle/manage',
	};
	$("#xx-select-type").on('change',function(){
		var selectedValue = $(this).val();
		$.ajax({
			type:"post",
			url:"/HosMa9/admin.php/Noticle/getData",
			async:true,
...
//				$('#seq').html(data.pageRes);	
    ...
    $('#xx-btn-refresh').click(function(){
    	location.href = '/HosMa9/admin.php/Noticle/review';
    });
    $("#xx-select-choosse").on('change',function(){
		var selectedValue = $(this).val();
		$.ajax({
			type:"post",
			url:"/HosMa9/admin.php/Noticle/getSourse",
			async:true,
			data:{'selectedValue':selectedValue},
			dataType:'json',
			success:function(data){
...
//		console.log(postData);
	...
	function clickCheck(obj){
		...
		location.href = '/HosMa9/admin.php/Noticle/manage'+'?id='+id+'&num='+num;
	}
	...
	//		console.log(id);
			var postData={};
			location.href = '/HosMa9/admin.php/Noticle/history'+'?id='+id;	
		}
	...
	$('#xx-span-click').click(function(){
		...
		$.ajax({
			type:"post",
			url:"/HosMa9/admin.php/Noticle/getSearch",
			async:true,
			data:postData,
			dataType:'json',
			success:function(data){
