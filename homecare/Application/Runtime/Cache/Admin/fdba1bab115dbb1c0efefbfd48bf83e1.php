		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<ol class="breadcrumb">
						...
						<a href="/homecare/admin.php/Community/index" class='active'>社区列表</a>
					</ol>
				</div>
			</div>
                  <!--
            ...
            <div class="row zyn-div-search">
            	<div class="col-md-4 col-md-offset-1">
	            	<form action="/homecare/admin.php/Community/index" method="post" class="form-horizontal">
	            		<div class="input-group">
	            			<span class='input-group-addon'>搜索</span>
	            	
	            				<input type="text" name="search" id="" value="" placeholder="请输入社区名" style="line-height: 27px;width: 248px;"/>
	            ...
	            <div class="col-md-4">
				<button type="button" class="btn btn-group btn-primary" id="zyn-btn-add">新增社区</button>
            		...
            		<div class="table-responsive">
            			<form id="zyn-form-list">
            				<table class="table table-bordered table-hover zyn-table-list">
            					...
            					<tbody>
            						<?php if(is_array($community)): $i = 0; $__LIST__ = $community;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
...
<script>
	var SCOPE = {
		...
		'success_refresh_url':'/homecare/admin.php/Community/index',
	};
</script>	
