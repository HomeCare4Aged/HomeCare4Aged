				...
				<div class="col-md-12">
					<ol class="breadcrumb">
						<li>
							...
							<a href="/1/admin.php/Menu/index">菜单管理</a>
						</li>
						<li class="active">
			...
			<div class="col-sm-10">
				<form id="zyn-form-add" class="form-horizontal">
					<div class="form-group">
						<label for="zyn-input-menu-name" class="control-label col-sm-3">菜单名:</label>
						<div class="col-sm-4">
							<input id="zyn-input-menu-name" class="form-control" type="text" 
							    name="menu_name" placeholder="请输入菜单名称"/>
						</div>
						<div class="col-sm-5">
							<p class="zyn-p-validate-result" attr-validate="menu_name"></p>
						</div>
					</div>
					<div class="form-group">
						<label for="zyn-input-menu-module" class="control-label col-sm-3">模块名:</label>
						<div class="col-sm-4">
							<input id="zyn-input-menu-module" class="form-control" type="text" 
							    name="menu_module" placeholder="请输入模块名称"/>
						</div>
						<div class="col-sm-5">
							<p class="zyn-p-validate-result" attr-validate="menu_module"></p>
						</div>
					</div>
					<div class="form-group">
						<label for="zyn-input-menu-controller" class="control-label col-sm-3">控制器名:</label>
						<div class="col-sm-4">
							<input id="zyn-input-menu-controller" class="form-control" type="text" 
							    name="menu_controller" placeholder="请输入控制器名称"/>
						</div>
						<div class="col-sm-5">
							<p class="zyn-p-validate-result" attr-validate="menu_controller"></p>
						</div>
					</div>
					<div class="form-group">
						<label for="zyn-input-menu-action" class="control-label col-sm-3">方法名:</label>
						<div class="col-sm-4">
							<input id="zyn-input-menu-action" class="form-control" type="text" 
							    name="menu_action" placeholder="请输入方法名称"/>
						</div>
						<div class="col-sm-5">
							<p class="zyn-p-validate-result" attr-validate="menu_action"></p>
						</div>
					</div>
					<div class="form-group">
...
<script>
	var SCOPE = {
		...
		'success_jump_url':'/1/admin.php/Menu/index',
	};
</script>	
